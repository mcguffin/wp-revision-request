...
Description: <strong>NO LONGER MAINTAINED.</strong> More revision control: Create revision only upon request. Controls to delete revisions. Display revisions on the blog.
Author: Joern Lund
Version: 1.0.2
